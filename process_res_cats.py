...
def op_res_cats_files(file_path,company,op_res_cats_report):
    ...
    ops=pd.DataFrame()
    templates=[]
    op_template=pd.read_excel('Prod_Cats/Datamodel OpCats-ResCats-LoV.xlsx',pd.ExcelFile('Prod_Cats/Datamodel OpCats-ResCats-LoV.xlsx').sheet_names[0])
    res_template=pd.read_excel('Prod_Cats/Datamodel OpCats-ResCats-LoV.xlsx',pd.ExcelFile('Prod_Cats/Datamodel OpCats-ResCats-LoV.xlsx').sheet_names[1])
